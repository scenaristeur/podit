...
export default {
  ...
  props: {
    item: Object,
    default: {url: "https://scenaristeur.github.io/podit", name: "PodIt"},
    variant: {
      type: String,
      default: "info"
    },},
    data(){
      return {
        it: {},
        sharing: {
          url: 'https://scenaristeur.github.io/podit',
          title: 'PodIt.',
          description: 'Build your website with podIt.',
          quote: 'Best way to easily share your thought',
          hashtags: 'PodIt,scenaristeur,decentralized,Solid,nodejs,vuejs',
